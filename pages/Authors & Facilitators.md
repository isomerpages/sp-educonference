...
Please be reminded that at least one author must register for the symposium before the deadline and attend the symposium in person to present the paper; or the paper will be withdrawn from the program.

Each full paper shall be accompanied by a single Approval Certificate, containing the necessary details and bearing the signature of the Lead Author for paper with more than one author. The Lead Author is responsible for ensuring consensus among all co-authors.
